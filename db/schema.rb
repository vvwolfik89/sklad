...
ActiveRecord::Schema[7.0].define(version: 2024_01_08_164541) do
  ...
  create_table "car_inspections", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "car_id"
    t.string "notes"
    t.json "elements"
  ...
  create_table "departments_users", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
